...
submission = 'subFTRL.csv'  # path of to be outputted submission file

# B, model
alpha = .1  # learning rate
beta = 1.   # smoothing parameter for adaptive learning rate
L1 = 0.3     # L1 regularization, larger value means more regularized
L2 = 1.2     # L2 regularization, larger value means more regularized
